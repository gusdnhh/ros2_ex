...
class DistTurtleServer(Node):
	...
	def parameter_callback(self, params):
		...
		print('quantile time andd almost goal time are changed',
	...
	def calc_diff_pose(self):
		...
		diff_dist = math.sqrt((self.previous_pose.x - self.current_pose.x)**2 + (self.previous_pose.y - self.current_pose.y)**2)
